...
\begin{figure}[h]
\centering
\includegraphics[width=14pc]{img/rootr.png}\caption{\label{rootr:label} ROOT-R design.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=14pc]{img/tmva.png}\caption{\label{tmva:label} Machine Learning Tools in ROOT.}
\end{figure}
...
\begin{figure}[h]
\begin{minipage}{14pc}
\includegraphics[width=14pc]{img/dl1.jpg}
\caption{\label{dl1}Booking methods with different dataloaders}
\end{minipage}\hspace{2pc}%
\begin{minipage}{14pc}
\includegraphics[width=14pc]{img/dl2.jpg}
\caption{\label{dl2}Loading data from files.}
\includegraphics[width=14pc]{img/dl3.jpg}
